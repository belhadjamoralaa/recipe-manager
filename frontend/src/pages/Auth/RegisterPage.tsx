        ...
        <div style={cardStyle}>
          ...
          <div className="mb-4 text-center text-md-start">
            <div style={badgeStyle}>
              <span style={dotStyle} />
              <span>Recipes App · Create account</span>
            </div>
            <h2 style={titleStyle}>Create your account</h2>
            <p style={subtitleStyle}>
              Save your favorite recipes, share your ideas, and keep everything in one place.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="d-grid gap-3">
            <div>
              ...
              <input
                ...
                required
                minLength={3}
                placeholder="chef_mk_aloui"
              />
              <div style={hintStyle}>This will be visible on your recipes and comments.</div>
            </div>
            ...
            <div>
              ...
              />
              <div style={hintStyle}>Use a password you don’t use anywhere else.</div>
            </div>
